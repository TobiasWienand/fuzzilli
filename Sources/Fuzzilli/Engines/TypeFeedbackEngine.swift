...
public class TypeFeedbackEngine: FuzzEngine {
    ...
    public init(numConsecutiveMutations: Int) {
        ...
        super.init(name: "TypeFeedbackEngine")
    }
    ...
    public override func fuzzOne(_ group: DispatchGroup) {
        // Draw a sample from the corpus
        var parent = fuzzer.corpus.randomElementForMutating()
        
        // Print reliably triggered locations and types from the sample
        //logger.info("Sample drawn from corpus. Reliable Locations: \(parent.reliableLocations), Reliable Types: \(parent.reliableTypes)")
