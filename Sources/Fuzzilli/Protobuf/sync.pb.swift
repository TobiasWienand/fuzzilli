...
public struct Fuzzilli_Protobuf_Statistics: @unchecked Sendable {
  ...
  //// The number of unique location_type tuples discovered.
  public var typeCoverageCount: UInt32 {
    get {return _storage._typeCoverageCount}
    set {_uniqueStorage()._typeCoverageCount = newValue}
  }
...
extension Fuzzilli_Protobuf_Statistics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    18: .same(proto: "typeCoverageCount"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _typeCoverageCount: UInt32 = 0
    ...
    init(copying source: _StorageClass) {
      ...
      _typeCoverageCount = source._typeCoverageCount
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 18: try { try decoder.decodeSingularUInt32Field(value: &_storage._typeCoverageCount) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._typeCoverageCount != 0 {
        try visitor.visitSingularUInt32Field(value: _storage._typeCoverageCount, fieldNumber: 18)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Fuzzilli_Protobuf_Statistics, rhs: Fuzzilli_Protobuf_Statistics) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._typeCoverageCount != rhs_storage._typeCoverageCount {return false}
        return true
      }
